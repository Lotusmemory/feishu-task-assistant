...
test('reports every missing required variable', () => {
  assert.throws(
    () => loadConfig({}),
    /FEISHU_APP_ID, FEISHU_APP_SECRET, MINIMAX_API_KEY, FEISHU_BASE_TOKEN, FEISHU_KNOWLEDGE_TABLE_ID, FEISHU_QUESTIONS_TABLE_ID, SILICONFLOW_API_KEY, FEISHU_TASKS_TABLE_ID, FEISHU_MEMBERS_TABLE_ID, TOKEN_ENCRYPTION_KEY, OAUTH_REDIRECT_URI/,
  );
});
